...
#ifndef _GEO_UNCAL_SENSOR_HAL_H_
#define _GEO_UNCAL_SENSOR_HAL_H_

#include <sensor_hal.h>

class geo_uncal_sensor_hal : public sensor_hal
{
public:
	geo_uncal_sensor_hal();
	virtual ~geo_uncal_sensor_hal();
...
#endif /*_GEO_UNCAL_SENSOR_HAL_H_*/
