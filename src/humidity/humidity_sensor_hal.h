...
#ifndef _HUMIDITY_SENSOR_HAL_H_
#define _HUMIDITY_SENSOR_HAL_H_

#include <sensor_hal.h>

class humidity_sensor_hal : public sensor_hal
{
public:
	humidity_sensor_hal();
	virtual ~humidity_sensor_hal();
...
#endif /*_HUMIDITY_SENSOR_HAL_CLASS_H_*/
