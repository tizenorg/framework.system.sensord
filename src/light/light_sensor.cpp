...
, m_level(-1)
{
	...
	register_supported_event(LIGHT_EVENT_CHANGE_LEVEL);
	register_supported_event(LIGHT_EVENT_LEVEL_DATA_REPORT_ON_TIME);
	register_supported_event(LIGHT_EVENT_LUX_DATA_REPORT_ON_TIME);
