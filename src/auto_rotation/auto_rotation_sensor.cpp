...
int auto_rotation_sensor::get_sensor_data(const unsigned int data_id, sensor_data_t &data)
{
...
bool auto_rotation_sensor::get_properties(sensor_type_t sensor_type, sensor_properties_t &properties)
{
