...
log_element g_log_elements[] = {
	...
	FILL_LOG_ELEMENT(LOG_ID_SENSOR_TYPE, GEOMAGNETIC_UNCAL_SENSOR, 0, 1),
	...
	FILL_LOG_ELEMENT(LOG_ID_SENSOR_TYPE, RV_RAW_SENSOR, 0, 1),
	FILL_LOG_ELEMENT(LOG_ID_SENSOR_TYPE, BIO_LED_GREEN_SENSOR, 0, 1),
	...
	FILL_LOG_ELEMENT(LOG_ID_EVENT, GYROSCOPE_UNCAL_EVENT_RAW_DATA_REPORT_ON_TIME, 0, 10),
	FILL_LOG_ELEMENT(LOG_ID_EVENT, GEOMAGNETIC_EVENT_RAW_DATA_REPORT_ON_TIME, 0, 10),
	FILL_LOG_ELEMENT(LOG_ID_EVENT, GEOMAGNETIC_UNCAL_EVENT_RAW_DATA_REPORT_ON_TIME, 0, 10),
	...
	FILL_LOG_ELEMENT(LOG_ID_EVENT, RV_RAW_EVENT_RAW_DATA_REPORT_ON_TIME, 0, 10),
	FILL_LOG_ELEMENT(LOG_ID_EVENT, BIO_LED_GREEN_EVENT_RAW_DATA_REPORT_ON_TIME, 0, 10),
	FILL_LOG_ELEMENT(LOG_ID_EVENT, GEOMAGNETIC_RV_EVENT_RAW_DATA_REPORT_ON_TIME, 0, 10),
	FILL_LOG_ELEMENT(LOG_ID_EVENT, GAMING_RV_EVENT_RAW_DATA_REPORT_ON_TIME, 0, 10),
	FILL_LOG_ELEMENT(LOG_ID_EVENT, TILT_EVENT_RAW_DATA_REPORT_ON_TIME, 0, 10),

	FILL_LOG_ELEMENT(LOG_ID_DATA, ACCELEROMETER_BASE_DATA_SET, 0, 25),
	FILL_LOG_ELEMENT(LOG_ID_DATA, GYRO_BASE_DATA_SET, 0, 25),
	FILL_LOG_ELEMENT(LOG_ID_DATA, GYROSCOPE_UNCAL_BASE_DATA_SET, 0, 25),
	...
	FILL_LOG_ELEMENT(LOG_ID_DATA, GEOMAGNETIC_UNCAL_BASE_DATA_SET, 0, 25),
	...
	FILL_LOG_ELEMENT(LOG_ID_DATA, RV_RAW_BASE_DATA_SET, 0, 25),
	FILL_LOG_ELEMENT(LOG_ID_DATA, BIO_LED_GREEN_BASE_DATA_SET, 0, 25),
	FILL_LOG_ELEMENT(LOG_ID_DATA, TILT_BASE_DATA_SET, 0, 25),
};
...
bool is_ontime_event(unsigned int event_type)
{
	...
	case GYROSCOPE_UNCAL_EVENT_RAW_DATA_REPORT_ON_TIME:
	case LIGHT_EVENT_LEVEL_DATA_REPORT_ON_TIME:
	case GEOMAGNETIC_EVENT_RAW_DATA_REPORT_ON_TIME:
	case GEOMAGNETIC_UNCAL_EVENT_RAW_DATA_REPORT_ON_TIME:
	...
	case BIO_LED_GREEN_EVENT_RAW_DATA_REPORT_ON_TIME:
	case TILT_EVENT_RAW_DATA_REPORT_ON_TIME:
		return true;
		break;
	}
...
unsigned int get_calibration_event_type(unsigned int event_type)
{
	...
	case RV_RAW_SENSOR:
		return RV_RAW_EVENT_CALIBRATION_NEEDED;
