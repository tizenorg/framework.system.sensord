...
#if !defined(_FLAT_PROCESSOR_CLASS_H_)
#define _FLAT_PROCESSOR_CLASS_H_
...
class flat_processor : public cprocessor_module {
public:
	flat_processor();
	virtual ~ flat_processor();
 ...
 private:
	...
	unsigned int m_flat_state_cb_client;

	string m_flat_state_cb_key;
